<template>
    ...
    <div class="inset-0 bg-gray-900 bg-opacity-80 flex justify-center items-center z-50 pb-20">
      <div class="max-w-2xl w-full mx-4 p-6 bg-gray-900 bg-opacity-90 backdrop-blur-lg shadow-xl rounded-lg border border-gray-700">
        <h2 class="text-2xl font-bold text-center text-white mb-2">How can we help you today?</h2>
        <p class="text-gray-300 text-center mb-6">
          Take a minute to share the problems your having and lets see if we can't find a solution that fits your needs.
        </p>
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
          ...
          <!-- Journey Story -->
          <div>
            <label class="block text-gray-200">Tell us what is going on...</label>
          ...
          <div>
            <label class="block text-gray-200">Attach any screenshots if needed.  (Optional)</label>
